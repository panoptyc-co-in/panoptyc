...
const Navbar = ({ onApply, onProfileSetup }) => {
  ...
  return (
    <nav
      ...
      style={{
        background: scrolled ? "rgba(255, 255, 255, 0.95)" : "linear-gradient(135deg,#0f172a,#1e293b 50%,#0f172a)",
    ...
    >
      ...
      {/* Mobile menu */}
      {mobileOpen && (
        <div className="md:hidden py-4 px-4" style={{ background: scrolled ? "rgba(255, 255, 255, 0.98)" : "rgba(15, 23, 42, 0.98)" }}>
