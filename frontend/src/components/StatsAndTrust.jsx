...
const StatsAndTrust = () => {
  return (
    <>
      {/* Stats Section */}
      <section className="py-12 md:py-16 !bg-[#FEF6F6]" style={{ backgroundColor: "#1a1f2e", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
            {statsData.map((stat, i) => {
              ...
              return (
                <div
                  key={i}
                  className="transition-all duration-200 hover:bg-white/5 text-center p-4 md:p-6 rounded-xl !shadow-lg !bg-[rgba(248,250,252,0.74)]"
