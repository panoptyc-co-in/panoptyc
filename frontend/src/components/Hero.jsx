...
const MonitoringDashboard = () => {
  ...
  return (
    <div className="rounded-2xl overflow-hidden shadow-2xl" style={{ background: "rgba(15,15,15,0.85)", backdropFilter: "blur(20px)", border: "1px solid rgba(255,255,255,0.1)" }}>
      {/* Window title bar */}
      ...
      {/* Alert notification */}
      <div className="mx-3 mb-3 flex items-center gap-3 rounded-xl p-3" style={{ background: "rgba(239,68,68,0.08)", border: "1px solid rgba(239,68,68,0.2)" }}>
...
const Hero = ({ onApply }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0" style={{ background: "linear-gradient(135deg, rgba(0,0,0,0.6) 0%, rgba(0,0,0,0.3) 50%, rgba(0,0,0,0.5) 100%)" }} />
